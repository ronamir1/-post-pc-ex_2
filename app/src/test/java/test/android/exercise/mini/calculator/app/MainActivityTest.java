...
public class MainActivityTest {
  ...
  @Test
  public void when_userClicksButtonInsertEquals_then_activityShouldForwardCallToCalculator_and_ShowTheExpectedCalculatorOutputRightAway() {
    // setup
    String expectedText = "button insert equals clicked";
    Mockito.when(mockCalculator.output()).thenReturn(expectedText);
